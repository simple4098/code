...
public class CompareTest {
    ...
    public void testCp(){
        ...
        omsComparePriceInnRoom.setSpecialStartDate("2016-07-04");
        omsComparePriceInnRoom.setSpecialEndDate("2016-07-20");
        //获取spider 去哪儿房价数据
        try {
            List<SpiderData> spiderData = InnRoomHelper.obtSpider(omsComparePriceInnRoom,"576cec4d9186e30005ce1ad4");
